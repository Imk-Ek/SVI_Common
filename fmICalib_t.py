...
# Form implementation generated from reading ui file 'D:\ormet\source\svi (4)\svi\forms\fmICalib.ui'
#
# Created: Mon Sep 17 14:02:56 2018
...
class Ui_fmICalib(object):
    def setupUi(self, fmICalib):
        ...
        fmICalib.resize(935, 870)
        fmICalib.setMinimumSize(QtCore.QSize(935, 870))
        fmICalib.setMaximumSize(QtCore.QSize(935, 870))
        self.centralwidget = QtGui.QWidget(fmICalib)
        self.centralwidget.setObjectName(_fromUtf8("centralwidget"))
        self.teCalib = QtGui.QTableWidget(self.centralwidget)
        self.teCalib.setGeometry(QtCore.QRect(10, 200, 621, 301))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.leZero.setGeometry(QtCore.QRect(280, 150, 81, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.leZero.setFont(font)
        self.leZero.setObjectName(_fromUtf8("leZero"))
        self.label_13 = QtGui.QLabel(self.centralwidget)
        self.label_13.setGeometry(QtCore.QRect(10, 150, 61, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.lepXu.setGeometry(QtCore.QRect(90, 150, 81, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.lepXu.setFont(font)
        self.lepXu.setObjectName(_fromUtf8("lepXu"))
        self.label_14 = QtGui.QLabel(self.centralwidget)
        self.label_14.setGeometry(QtCore.QRect(230, 146, 51, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.label_15.setGeometry(QtCore.QRect(370, 139, 61, 41))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.groupBox.setGeometry(QtCore.QRect(10, 590, 731, 161))
        self.groupBox.setObjectName(_fromUtf8("groupBox"))
        self.label_37 = QtGui.QLabel(self.groupBox)
        self.label_37.setGeometry(QtCore.QRect(10, 100, 121, 21))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.leProfilName_.setGeometry(QtCore.QRect(270, 40, 421, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.label_40.setGeometry(QtCore.QRect(20, 40, 241, 21))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.leDescr_.setGeometry(QtCore.QRect(140, 100, 551, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.tbSaveProfilIon.setGeometry(QtCore.QRect(230, 770, 341, 51))
        self.tbSaveProfilIon.setObjectName(_fromUtf8("tbSaveProfilIon"))
        self.groupBox_2 = QtGui.QGroupBox(self.centralwidget)
        self.groupBox_2.setGeometry(QtCore.QRect(10, 0, 381, 101))
        self.groupBox_2.setObjectName(_fromUtf8("groupBox_2"))
        self.tbSelectIon = QtGui.QToolButton(self.groupBox_2)
        self.tbSelectIon.setGeometry(QtCore.QRect(10, 35, 151, 51))
        self.tbSelectIon.setObjectName(_fromUtf8("tbSelectIon"))
        self.tbGrad = QtGui.QToolButton(self.groupBox_2)
        self.tbGrad.setGeometry(QtCore.QRect(230, 35, 151, 51))
        self.tbGrad.setObjectName(_fromUtf8("tbGrad"))
        self.groupBox_3 = QtGui.QGroupBox(self.centralwidget)
        self.groupBox_3.setGeometry(QtCore.QRect(510, 20, 391, 151))
        self.groupBox_3.setObjectName(_fromUtf8("groupBox_3"))
        self.label_4 = QtGui.QLabel(self.groupBox_3)
        self.label_4.setGeometry(QtCore.QRect(20, 110, 271, 20))
        self.label_4.setObjectName(_fromUtf8("label_4"))
        self.label_5 = QtGui.QLabel(self.groupBox_3)
        self.label_5.setGeometry(QtCore.QRect(20, 43, 46, 20))
        self.label_5.setObjectName(_fromUtf8("label_5"))
        self.label_6 = QtGui.QLabel(self.groupBox_3)
        self.label_6.setGeometry(QtCore.QRect(20, 75, 231, 21))
        self.label_6.setObjectName(_fromUtf8("label_6"))
        self.lblKIon = QtGui.QLabel(self.groupBox_3)
        self.lblKIon.setGeometry(QtCore.QRect(300, 101, 91, 31))
        self.lblKIon.setObjectName(_fromUtf8("lblKIon"))
        self.lblMol_Massa = QtGui.QLabel(self.groupBox_3)
        self.lblMol_Massa.setGeometry(QtCore.QRect(300, 76, 71, 20))
        self.lblMol_Massa.setObjectName(_fromUtf8("lblMol_Massa"))
        self.lblIon = QtGui.QLabel(self.groupBox_3)
        self.lblIon.setGeometry(QtCore.QRect(300, 53, 91, 20))
        ...
        self.label_7.setGeometry(QtCore.QRect(650, 207, 101, 21))
        self.label_7.setObjectName(_fromUtf8("label_7"))
        self.lblIon_3 = QtGui.QLabel(self.centralwidget)
        self.lblIon_3.setGeometry(QtCore.QRect(780, 210, 71, 21))
        self.lblIon_3.setObjectName(_fromUtf8("lblIon_3"))
        self.label_8 = QtGui.QLabel(self.centralwidget)
        self.label_8.setGeometry(QtCore.QRect(10, 110, 291, 21))
        self.label_8.setObjectName(_fromUtf8("label_8"))
        self.leS_min = QtGui.QLineEdit(self.centralwidget)
        self.leS_min.setGeometry(QtCore.QRect(770, 284, 81, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.leS_min.setFont(font)
        self.leS_min.setObjectName(_fromUtf8("leS_min"))
        self.label_16 = QtGui.QLabel(self.centralwidget)
        self.label_16.setGeometry(QtCore.QRect(670, 284, 81, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.label_9.setGeometry(QtCore.QRect(650, 247, 241, 21))
        self.label_9.setObjectName(_fromUtf8("label_9"))
        self.tbAddRow = QtGui.QToolButton(self.centralwidget)
        self.tbAddRow.setGeometry(QtCore.QRect(10, 520, 201, 51))
        self.tbAddRow.setObjectName(_fromUtf8("tbAddRow"))
        self.tbDelRow = QtGui.QToolButton(self.centralwidget)
        self.tbDelRow.setGeometry(QtCore.QRect(250, 520, 191, 51))
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 935, 38))
