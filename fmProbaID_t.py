...
# Form implementation generated from reading ui file 'D:\ormet\source\svi (4)\svi\forms\fmProbaID.ui'
#
# Created: Mon Sep 17 13:56:27 2018
...
class Ui_fmProbaID(object):
    def setupUi(self, fmProbaID):
        ...
        fmProbaID.resize(318, 224)
        fmProbaID.setMinimumSize(QtCore.QSize(318, 224))
        fmProbaID.setMaximumSize(QtCore.QSize(318, 224))
        self.centralwidget = QtGui.QWidget(fmProbaID)
        self.centralwidget.setObjectName(_fromUtf8("centralwidget"))
        self.lePassword = QtGui.QLineEdit(self.centralwidget)
        self.lePassword.setGeometry(QtCore.QRect(50, 40, 191, 41))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.tbEnterPassword.setGeometry(QtCore.QRect(70, 130, 151, 51))
