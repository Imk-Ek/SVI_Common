...
# Form implementation generated from reading ui file 'D:\ormet\source\svi_vs_v.0.3\forms\fmMBCons.ui.old'
#
# Created: Thu Jan 30 13:16:41 2014
...
class Ui_fmMBCons(object):
    def setupUi(self, fmMBCons):
        ...
        self.lcdFloat = QtGui.QLCDNumber(self.centralwidget)
        self.lcdFloat.setGeometry(QtCore.QRect(250, 50, 161, 41))
        self.lcdFloat.setObjectName(_fromUtf8("lcdFloat"))
        ...
        self.cbFloat = QtGui.QComboBox(self.centralwidget)
        self.cbFloat.setGeometry(QtCore.QRect(250, 20, 161, 22))
        self.cbFloat.setObjectName(_fromUtf8("cbFloat"))
        ...
        self.tbFloatRd = QtGui.QToolButton(self.centralwidget)
        self.tbFloatRd.setGeometry(QtCore.QRect(420, 70, 27, 22))
        self.tbFloatRd.setObjectName(_fromUtf8("tbFloatRd"))
    ...
    def retranslateUi(self, fmMBCons):
        ...
        self.tbFloatRd.setText(_translate("fmMBCons", "Rd", None))
