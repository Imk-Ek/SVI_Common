...
# Form implementation generated from reading ui file 'fmNewConv.ui'
#
# Created: Fri Feb  1 13:11:47 2013
...
class Ui_fmNewConv(object):
    ...
    def retranslateUi(self, fmNewConv):
        fmNewConv.setWindowTitle(QtGui.QApplication.translate("fmNewConv", "Масштабирование", None, QtGui.QApplication.UnicodeUTF8))
        self.label_3.setText(QtGui.QApplication.translate("fmNewConv", "Выход =  <b>К</b>*(<b>C</b><sub>АЦП</sub> - <b>С</b><sub>0</sub>)", None, QtGui.QApplication.UnicodeUTF8))
        self.label_6.setText(QtGui.QApplication.translate("fmNewConv", "<b>К</b> =  <b>A</b><sub>Э</sub> / <b>С</b><sub>И ЗМ</sub>", None, QtGui.QApplication.UnicodeUTF8))
        self.tbSampleC_K.setText(QtGui.QApplication.translate("fmNewConv", "Загрузить", None, QtGui.QApplication.UnicodeUTF8))
        self.tbSampleC0.setText(QtGui.QApplication.translate("fmNewConv", "Загрузить", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate("fmNewConv", "<b>С</b><sub>0</sub> - поправка ноля:", None, QtGui.QApplication.UnicodeUTF8))
        self.label_4.setText(QtGui.QApplication.translate("fmNewConv", "<b>С</b><sub>И ЗМ</sub> -  измеренный код АЦП:", None, QtGui.QApplication.UnicodeUTF8))
        self.label_5.setText(QtGui.QApplication.translate("fmNewConv", "<b>A</b><sub>Э</sub> - эталон, соотв. коду <b>С</b><sub>И ЗМ</sub>:", None, QtGui.QApplication.UnicodeUTF8))
        self.label_2.setText(QtGui.QApplication.translate("fmNewConv", "<b>К</b> - коэффициент пересчета:", None, QtGui.QApplication.UnicodeUTF8))
        self.tbCalcK.setText(QtGui.QApplication.translate("fmNewConv", "Рассчитать", None, QtGui.QApplication.UnicodeUTF8))
